...
const FILE_DOWNLOADS = [
  'media/images/grubynikos.jpg'
]

const PHRASES = [
  'HAHA IDIOTO MYŚLAŁEŚ ŻE SERIO POWIEM COŚ NA PABLA XDDDDDDDDDDDDDDDDDDDDDD',
  'ANDORA ZDECHŁA I TYLE',
  'JEBAĆ GAMERA KURWE JEBANĄ',
  'NIKODEM JEST GRUBY',
  'POZDRO OD RICKA CWELE',
  'Dzięki Jaczup za source code <3'
]
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'andoracity')
  })
}
